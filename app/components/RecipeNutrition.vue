<template>
  <div v-if="nutrition" class="space-y-4">
    <h2 class="text-2xl mb-4">Nutrition Information</h2>
        ...
        <div class="space-y-2">
          <div class="flex justify-between">
            ...
            <span class="font-semibold"
              >{{ Math.round(nutrition.total.energyKcal) }} kcal</span
            >
          </div>
          <div class="flex justify-between">
            <span>Protein:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.total.proteins * 10) / 10 }}g</span
            >
          </div>
          <div class="flex justify-between">
            <span>Carbohydrates:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.total.carbohydrates * 10) / 10 }}g</span
            >
          </div>
          <div class="flex justify-between">
            <span>Fat:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.total.fat * 10) / 10 }}g</span
            >
          </div>
          <div class="flex justify-between">
            <span>Fiber:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.total.fiber * 10) / 10 }}g</span
            >
          </div>
          <div class="flex justify-between">
            <span>Sugars:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.total.sugars * 10) / 10 }}g</span
            >
          </div>
          <div class="flex justify-between">
            <span>Salt:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.total.salt * 10) / 10 }}g</span
            >
          </div>
        </div>
      </div>
      ...
      <div class="border rounded-lg p-4">
        ...
        <div class="space-y-2">
          <div class="flex justify-between">
            <span>Energy:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.perServing.energyKcal) }} kcal</span
            >
          </div>
          <div class="flex justify-between">
            <span>Protein:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.perServing.proteins * 10) / 10 }}g</span
            >
          </div>
          <div class="flex justify-between">
            <span>Carbohydrates:</span>
            <span class="font-semibold"
              >{{
                Math.round(nutrition.perServing.carbohydrates * 10) / 10
              }}g</span
            >
          </div>
          <div class="flex justify-between">
            <span>Fat:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.perServing.fat * 10) / 10 }}g</span
            >
          </div>
          <div class="flex justify-between">
            <span>Fiber:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.perServing.fiber * 10) / 10 }}g</span
            >
          </div>
          <div class="flex justify-between">
            <span>Sugars:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.perServing.sugars * 10) / 10 }}g</span
            >
          </div>
          <div class="flex justify-between">
            <span>Salt:</span>
            <span class="font-semibold"
              >{{ Math.round(nutrition.perServing.salt * 10) / 10 }}g</span
            >
          </div>
        </div>
      </div>
